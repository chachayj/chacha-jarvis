...
onMounted(() => {
  if (location.protocol !== "https:" && location.hostname !== "localhost") {
    notice.value =
      "⚠️ 모바일/사설 IP에서 HTTP로 접속하면 브라우저가 마이크를 차단할 수 있습니다. 가능하면 HTTPS를 사용하세요.";
  } else {
    notice.value = "✅ 마이크 권한 요청이 가능합니다.";
  }
});

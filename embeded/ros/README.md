...
| [08. RC카 ESP32 개조](docs/08-rccar-esp32.md) | Rastar 97400 조립키트 → ESP32 제어 전환. 설계 근거·부품 매핑·브로커 위치·워치독·배선도 |
| [09. RC카 작업 순서](docs/09-rccar-work-order.md) | **위 개조의 실행 체크리스트.** 무엇을 언제 하는지 + 순서를 바꾸면 안 되는 지점 |
